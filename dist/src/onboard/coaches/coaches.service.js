    ...
    async remove(id) {
        try {
            ...
            if (err instanceof Error) {
                throw new common_1.HttpException(Object.assign(Object.assign({}, err), { message: 'Error while remove coach | reminders' }), common_1.HttpStatus.INTERNAL_SERVER_ERROR);
            }
        }
    }
    async update(id, dto) {
        ...
        if (!result) {
            throw new common_1.HttpException({ message: 'coach not found' }, common_1.HttpStatus.NOT_FOUND);
        }
        return result;
    }
