...
exports.VerifiedEmailGuard = void 0;
...
let VerifiedEmailGuard = class VerifiedEmailGuard {
    ...
    async canActivate(context) {
        ...
        if (!isVerified) {
            throw new common_1.ForbiddenException('Identity not verified');
        }
        return true;
    }
};
VerifiedEmailGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [ses_service_1.SesService,
        customers_service_1.CustomersService])
], VerifiedEmailGuard);
exports.VerifiedEmailGuard = VerifiedEmailGuard;
//# sourceMappingURL=verified-email-guard.service.js.map