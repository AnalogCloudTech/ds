...
let CustomerTemplateRepository = class CustomerTemplateRepository extends generic_repository_1.GenericRepository {
    constructor(model) {
        super(model);
        this.model = model;
    }
...
CustomerTemplateRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(customer_template_schema_1.CustomerTemplate.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], CustomerTemplateRepository);
exports.CustomerTemplateRepository = CustomerTemplateRepository;
//# sourceMappingURL=customer-template.repository.js.map