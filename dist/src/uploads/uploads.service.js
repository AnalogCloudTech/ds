...
let UploadsService = class UploadsService {
    ...
    create(customer, createUploadDto, uploadUrl) {
        return this.uploadRepository.create(customer, Object.assign(Object.assign({}, createUploadDto), { uploadUrl }));
    }
    findAll(customer) {
        return this.uploadRepository.findAll(customer);
    }
    findOne(customer, uploadId) {
