export type Subscription = {
  ...
  canceled_at: string; // String date - Wed, 04 Oct 2023 12:09:32 EDT -04:00
  cancellation_message: string;
  coupon_code: string;
  created_at: string; // String date - Wed, 04 Oct 2023 12:09:32 EDT -04:00
  current_period_ends_at: string; // String date - Wed, 04 Oct 2023 12:09:32 EDT -04:00
  current_period_started_at: string; // String date - Wed, 04 Oct 2023 12:09:32 EDT -04:00
...
export type SubscriptionComponent = {
  ...
  recurring?: boolean;
  description?: string;
  archived_at?: string | null; // String date - Wed, 04 Oct 2023 12:09:32 EDT -04:00
...
export class SubscriptionPayload {
  ...
  event_id: number;
  timestamp: string; // String date - Wed, 04 Oct 2023 12:09:32 EDT -04:00
  component: Component;
}

export class RenewalSuccessPayload {
  site: Site;
  subscription: Subscription;
  event_id: number;
}
...
export class InvoiceIssuedSubscription {
  id: string;
  current_period_ends_at: string;
}

export class InvoiceIssuedInvoice {
  uid: string;
  number: string;
  role: string;
  due_date: string;
...
export class InvoiceIssuedPayload {
  message: string;
  site: Site;
...
export class SubscriptionUpdatedPayload {
  site: Site;
...
export class WebhookPayload<T = any> {
  id: number;
  event: string;
  payload: T;
  [key: string]: any;
...
export interface ClickFunnelsPurchasePayload {
  ...
  created_at: string; //'2022-12-08T16:02:44.000Z';
  updated_at: string; //'2022-12-08T16:02:44.000Z';
...
export interface ClickFunnelsProducts {
  ...
  created_at: string; //'2020-10-30T13:41:04.000Z';
  updated_at: string; //'2022-02-10T16:06:02.000Z';
  subject: unknown;
  html_body: unknown;
...
export interface ClickFunnelsContact {
  ...
  webinar_ext: string;
  created_at: string; // '2022-12-08T16:02:43.000Z';
  updated_at: string; // '2022-12-08T16:02:43.000Z';
  ip: string;
  funnel_id: number;
  ...
  text: string;
  text_message_opt_in: string; // 'true';
  book_credits: number;
}
